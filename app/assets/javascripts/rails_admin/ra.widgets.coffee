  ...
  if content.length # don't waste time otherwise
    ...
    goMarkitups = (array, config_options) =>
      markitup_settings = {
        ...
        markupSet: [
          {name:'First Level Heading', key:"1", placeHolder:'Your title here...', closeWith: -> return miu.markdownTitle(markItUp, '=') },
          {name:'Second Level Heading', key:"2", placeHolder:'Your title here...', closeWith: -> return miu.markdownTitle(markItUp, '-') },
